...
public class ElasticDragDismissFrameLayout extends FrameLayout {
    ...
    private float dragDismissScale = .75f; // 0..1
    ...
    private void init() {
        dragDismissDistance = dip2px(240);
        alplaDistance = dip2px(500);
...
//                ||
//                (velocityY < 0 && !ViewCompat.canScrollVertically(target, 1))) {
//            handle = true;
//            dragScale((int) getSplineFlingDistance((int) velocityY));
//        }
//        return handle;
//    }
//
